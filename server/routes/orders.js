...
const orders = (router) => {
  ...
  router.post(
    ...
    validateOrder.isOpen, validateOrder.mealValid, validateOrder.mealInMenu,
    validateOrder.quantityValid, ErrorHandler.handleErrors,
    AsyncWrapper(OrderController.post),
  );
   ...
   */
  router.put(
    '/orders/:id', validateAccount.user, validateOrder.orderValid,
    validateOrder.mealValidIfPassed,
   ...
   */
  router.get(
    '/orders', validateAccount.user, ValidateQuery.validateLimit,
    ValidateQuery.validateOffset, ErrorHandler.handleErrors,
    AsyncWrapper(OrderController.get),
  );
   ...
   */
  router.get(
    '/orders/summary', validateAccount.user, validateAccount.caterer,
    ValidateQuery.validateLimit, ValidateQuery.validateOffset,
    ErrorHandler.handleErrors,
    AsyncWrapper(OrderController.summary),
  );
};
