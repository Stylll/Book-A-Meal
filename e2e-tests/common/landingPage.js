...
module.exports = {
  'Landing page should display expected information': function (browser) {
    browser
      ...
      .assert.containsText('#app > div > div > div > div.main > div > div > h3:nth-child(4)', 'We create a platform for customers to enjoy classy and tasty meals while leveraging the finesse of our world className caterers who are masters of their craft')
